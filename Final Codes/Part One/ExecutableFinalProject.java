...
public class ExecutableFinalProject {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			//Creating the object in each element in the array. 
			array[i] = new Team();
			array[i].setRank(rank[i]);
			array[i].setSolvedQuestion(randomGenerator.nextInt(10));
			array[i].setElapsedTimeD(randomGenerator.nextInt(300));
